...
const AddFieldScreen = ({ navigation }) => {
    ...
    return (
            ...
            <ScrollView style={{width: '100%', paddingTop: '5%'}}>
                ...
                <TouchableOpacity style={[styles.button, {margin: '5%', marginTop: '5%', width: '80%', backgroundColor: '#62C962', alignSelf: 'center'}]}>
                        <Text style={{textAlign: 'center', fontWeight: 'bold', fontSize: 22, color: '#fff', marginLeft: '10%', marginRight: '10%'}}>Add New Filed</Text>
                </TouchableOpacity>
                </ScrollView>
